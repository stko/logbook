...
class TasksHandler  {
	...
	*/
	...
	public function createTask($wzID,$task,$title,$content){
		global $actualUser;
		// todo diese Funktion fehlt ja wohl noch
	}

	public function editTask($wzID,$task,$title,$content){
		/* todo diese Funktion fehlt ja wohl noch
		Man darf einen Task nur dann ändern, wenn er nicht schon als 
		Lösung bei einem Request eingetragen ist,
		*/
	}
